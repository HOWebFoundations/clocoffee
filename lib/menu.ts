...
export const menu: MenuItem[] = [
  ...
  { id: "latte", category: "coffee", usd: 6.75, popular: true,
    ...
    note: { en: "In the clear clocoffee glass", ar: "في كوب كلوكوفي الشفاف", fr: "Dans le verre clocoffee transparent" } },
  ...
  { id: "matcha-latte", category: "matcha", usd: 8.25, popular: true,
    ...
    note: { en: "Stone-ground, whisked to order", ar: "مطحونة على الحجر، تُخفق عند الطلب", fr: "Moulu \u00e0 la pierre, fouett\u00e9 \u00e0 la commande" } },
